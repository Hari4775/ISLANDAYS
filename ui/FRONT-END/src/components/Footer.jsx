  ...
  return (
    ...
    >
      <div className="w-full flex justify-between items-center max-w-7xl mx-auto">
        <p className="text-white text-md font-bold flex text-center text-3xl">
        from <span className="text-green-500 text-3xl ml-2">H2</span> 
        </p>
          ...
          {socials.map((social) => (
            ...
            >
              <Link to={social.link} target="_blank" rel="noreferrer noopener">
                <img src={social.icon} alt={social.name} className="h-6 w-6 text-white-100" />
              </Link>
            </li>
          ))}
        </ul>
